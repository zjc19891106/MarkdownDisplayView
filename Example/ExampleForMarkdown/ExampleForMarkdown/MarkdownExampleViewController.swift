...
let sampleMarkdown = """
    ...
    日文和中文应铺满行宽后才折行；\n如果出现「レポー」单独一行、「ト」再一行，就是换行异常。英文按单词折行即可。

    こんにちは、ご参加いただいた「各評価〜レポート」が生成されました。下記カードをクリックしてレポートをプレビュー、ダウンロードして保存してご覧いただけます。
    ワンポイントアドバイス！、360度評価レポートは、\n自分自身を各視点から知ることの役立つ鏡であり、現段階の強みと弱みを把握し、感情や認識をしていただけると思います。

    你好，感谢参与本次各级评价。系统已经生成对应的评价报告，请点击下方卡片预览报告，下载后保存即可查看。\n一点建议：三百六十度评价报告像一面镜子，能从多个视角认识自己，帮助看清当前阶段的优势与不足，也便于整理情绪和自我认知。
